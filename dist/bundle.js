...
/***/ function(module, exports, __webpack_require__) {
	...
	var reducers_1 = __webpack_require__(43);
	var counter_1 = __webpack_require__(44);
	var store = redux.createStore(reducers_1.reducers, {}, redux.applyMiddleware(redux_thunk_1.default));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var react_redux_1 = __webpack_require__(25);
	var actions_1 = __webpack_require__(45);
	...
	var CounterComponent = function (_React$Component) {
	    ...
	    function CounterComponent() {
	        ...
	        var _this = _possibleConstructorReturn(this, (CounterComponent.__proto__ || Object.getPrototypeOf(CounterComponent)).apply(this, arguments));
	
	        _this._onClickIncrement = function (e) {
	            e.preventDefault();
	        ...
	        _this._onClickSave = function (e) {
	            ...
	            if (!_this.props.isSaving) {
	                _this.props.save(_this.props.counter.value);
	            }
	        };
	        _this._onClickLoad = function (e) {
	            e.preventDefault();
...
/***/ function(module, exports, __webpack_require__) {
	...
	Object.defineProperty(exports, "__esModule", { value: true });
	var api_1 = __webpack_require__(46);
	exports.incrementCounter = function (delta) {
	    return {
	...
	var _saveCount = {
	    request: function request(_request) {
	        return { type: 'SAVE_COUNT_REQUEST', request: _request };
	    },
	    success: function success(response, request) {
	        return { type: 'SAVE_COUNT_SUCCESS', request: request, response: response };
	    },
	    error: function error(_error, request) {
	        return { type: 'SAVE_COUNT_ERROR', request: request, error: _error };
	    }
	};
	var _loadCount = {
	    request: function request(_request2) {
	        return { type: 'LOAD_COUNT_REQUEST', request: null };
	    },
	    success: function success(response, request) {
	        return { type: 'LOAD_COUNT_SUCCESS', request: null, response: response };
	    },
	    error: function error(_error2, request) {
	        return { type: 'LOAD_COUNT_ERROR', request: null, error: _error2 };
	    }
	};
	function apiActionGroupFactory(x, go) {
	    return function (request) {
	        return function (dispatch) {
	            ...
	            go(request).then(function (response) {
	                return dispatch(x.success(response, request));
	            }).catch(function (e) {
	                return dispatch(x.error(e, request));
	            });
	        };
	    };
	}
	exports.saveCount = apiActionGroupFactory(_saveCount, api_1.api.save);
	exports.loadCount = function () {
	    return apiActionGroupFactory(_loadCount, api_1.api.load)(null);
	};
...
/***/ function(module, exports) {
	...
	var flakify = function flakify(f) {
